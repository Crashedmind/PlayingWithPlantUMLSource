...
|playbutton0| Press to play around with this diagram source online.

.. |playbutton0| image:: ../play.png
...
Here we use the :ref:`together` keyword.


.. tip ::
    The :ref:`together` keyword allows you to specify what icons you want to group together.
